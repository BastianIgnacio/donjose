...
<head>
  ...
  <link href="{{ asset('temp/styles/styles.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/flat-icon/flaticon.css') }}" rel="stylesheet">
...
<body>
  <div class="main-wrapper">
        ...
        <nav class="navbar">
          ...
          <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav pull-right">
              ...
              <li><a href="#leasingHabitacional">Leasing Habitacional</a></li> 
              <li><a href="#mutuoHipotecario">Mutuo Hipotecario</a></li> 
              <li><a href="#">Pre-evaluación</a></li> 
      ...
      <div class="container">
        <div class="page-section">
          <div class="text-center">
            <h2 class="page-section__title">Sobre Nosotros </h2>
          </div>
        ...
        <div class="page-section">
          ...
          <div class="row gutters-50">
            <div class="about--narrow">
              ...
              <div class="col-md-6 about__extra-padding">
                <h3 class="about__content-title">REQUISITOS PARA OPTAR A UN FINANCIAMIENTO </h3>
                <p class="about__content-subTitle">
                    Debes ser mayor de 21 años <br> 
                    Nacionalidad Chilena <br>
                    Extranjero con residencia definitiva en el pais <br>
                    No ser dueño de una propiedad <br>
                    Cumplir con las politicas de crédito que te informaremos previamente  <br>
                </p>
    ...
    <section class="about">
      ...
      <section class="service" id="inicio" >
      <div class="container">
        <div class="page-section text-center">
          <h2 class="page-section__title">Servicios que ofrecemos</h2>
          <p class="page-section__paragraph">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
          <div class="row gutters-40">
            <div class="col-md-6">
              <div class="thumbnail">
                <i class="material-icons">trending_up</i>
                <h4 class="service__title"> Leasing Habitacional</h4>
                <p class="service__paragraph">
                Financia tu primera Futura Vivienda, a través de un contrato con promesa de compraventa, pagando una cuota mensual fija durante todo el plazo.  Al terminar de pagar la última cuota del plazo acordado, eres el propietario.
                </p>
                <a class="button--light" href="#">Más info</a>
              </div>
            </div>
            <div class="col-md-6">
              <div class="thumbnail">
                <i class="material-icons">access_time</i>
                <h4 class="service__title">Mutuo Hipotecario</h4>
                <p class="service__paragraph">
                Puedes acceder a financiar tu primera vivienda, la propiedad queda a tu nombre desde el primer momento.
                </p>
                <a class="button--light" href="#">Más info </a>
              </div>
            </div>
